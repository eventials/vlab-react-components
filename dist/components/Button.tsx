...
const getBackgroundColor = ({ type, variant, disabled }: StyledButtonProps): string => {
...
const getBorderColor = ({ type, variant, disabled }: StyledButtonProps): string => {
  if (disabled) return colorsList.lightGray;
...
const getHoverBackgroundColor = ({ type, variant, disabled }: StyledButtonProps): string => {
  if (disabled) return colorsList.lightGray;
