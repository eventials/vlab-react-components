...
interface IPageHeader extends PageHeaderProps {
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Componente de logo da Vlab, possui 3 tamanhos diferentes baseados na
          altura do logo: small (45px), medium (80px) e large(120px)
        </p>
    ...
    description: (
      <>
        ...
        <Column>
          ...
          <Button type="primary" loading variant="contained">
            Loading
          </Button>
        </Column>
      </>
  ...
  },
  {
    ...
    description: (
      <>
        ...
        <Typography type="body1">
          Aceita como propriedade o nome da permissão que deve existir no token
          ou uma expressão boleana para que o componente filho seja renderizado.
        </Typography>
...
`,
    doc: `
type PermissionsType = 'anamneseForm'
