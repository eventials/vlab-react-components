...
export const UserMenu = ({ arrowLeftClick, permissions }: IUserMenu) => {
    ...
    const content = (
        <StyledList>
            <div className="user">
                ...
                <div>
                    <Typography type="subtitle1" color="primary">Pietro Barcarollo</Typography>
                    <Typography type="caption" color="regentGray">Grupo Fleury</Typography>
                </div>
            </div>

            <section>
                <a className="divider" href="#">
                    <Typography type="subtitle2" color="regentGray">Alterar dados</Typography>
                    <RightOutlined />
                </a>
                <a className="divider" href="#">
                    <Typography type="subtitle2" color="regentGray">Alterar senha</Typography>
                    <RightOutlined />
                </a>
            </section>
    ...
    return (
        <StyledUserMenu>
            {isMobile &&
                <UserMenuTopbar>
                    <Typography type="subtitle2" color="white">Perfil</Typography>
                    <ArrowLeftOutlined onClick={arrowLeftClick} style={{ fontSize: 16, color: colors.white }} />
                </UserMenuTopbar>}
            {content}
        </StyledUserMenu>
    )
